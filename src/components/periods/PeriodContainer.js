...
const PeriodContainer = () => {
  ...
  return (
    <div className="period-container">
      {us.user 
      ? 
      <h3>Signed in as {us.user.username}</h3> 
      : 
      <h3>You are not signed in. <br/><Link to="/sign-in">Sign in</Link>, or <Link to="/create-account">create an account</Link> to save notes on the scores you view.</h3>}
      {cs.composers && (
        <div>
